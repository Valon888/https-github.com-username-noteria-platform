<?php
/**
 * Zyrat Register - Data Backup System
 * 
 * Professional registration system for notary offices with automatic
 * data backup capabilities, payment verification, and SMS confirmation.
 * 
 * @author  Noteria Development Team
 * @version 2.0 (Backup Edition)
 * @license MIT
 * @created 2024
 * @purpose Secure data backup and recovery for notary office registrations
 */
...
function backupRegistrationData(array $data, string $type = 'registration'): bool {
    try {
        ...
        $backup_file = BACKUP_DIR . "/{$type}_{$timestamp}_" . uniqid() . '.json';
        ...
        // Keep only last 100 backups per type
    ...
    if (
        ...
        if (!$payment_verified) {
            ...
            try {
                ...
                $office_inserted = $stmt->execute([$emri, $qyteti, $shteti, $email, $telefoni, $banka, $iban, $llogaria, $pagesa, $transaction_id, $payment_method]);
                ...
                $pdo->rollback();
                $error = "Ndodhi një gabim i papritur: " . $e->getMessage();
...
<body>
    <div class="page-wrapper">
        <div class="header-section">
            <h1><i class="fas fa-balance-scale"></i> Noteria</h1>
            <p>Platforma e Sigurt për Shërbime Noteriale</p>
        </div>

        <div class="container">
            <div class="form-header">
                <h2><i class="fas fa-registered"></i> Regjistro Zyrën Noteriale</h2>
                <p>Procesi i regjistrimit është i thjeshtë dhe i sigurt</p>
            </div>

            <div class="form-content">
                <div class="instructions-box">
                    <h4><i class="fas fa-info-circle"></i> Udhëzime Regjistrimi</h4>
                    <ul>
                        <li>Plotësoni të gjitha fushat e detyrueshme</li>
                        <li>Ngarkoni dëshminë e pagesës (PDF, JPG ose PNG)</li>
                        <li>Gjeneroni një ID transaksioni unike</li>
                        <li>Verifikohet brenda 3 minutave automatikisht</li>
                        <li>Merrni email konfirmimi pas verifikimit</li>
                    </ul>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data" id="registration-form">
                    ...
                    <div class="section-group">
                        <div class="section-title">
                            <i class="fas fa-building"></i> Të Dhënat e Zyrës Noteriale
                        </div>
                        <div class="form-columns">
                            <div class="form-group">
                                <label>Emri i Zyrës <span class="required">*</span></label>
                                <div class="input-wrapper">
                                    <i class="fas fa-signature input-icon"></i>
                                    <input type="text" name="emri" placeholder="Emri zyrtar i zyrës noteriale" required>
                                </div>
                                <small class="field-info">Emri siç figuron në dokumentet e regjistrimit</small>
                            </div>
                            <div class="form-group">
                                <label>Qyteti <span class="required">*</span></label>
                                <div class="input-wrapper">
                        ...
                        <div class="form-columns">
                            <div class="form-group">
                                <label>Email Zyrtar <span class="required">*</span></label>
                                <div class="input-wrapper">
                                    <i class="fas fa-envelope input-icon"></i>
                                    <input type="email" name="email" placeholder="zyra@domain.com" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="email" name="email2" placeholder="zyra@domain.com" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-columns">
                            ...
                            <div class="form-group">
                                <label>Vendi <span class="required">*</span></label>
                                <div class="input-wrapper">
                                    <i class="fas fa-flag input-icon"></i>
                                    <input type="text" value="Kosova" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-group">
                        <div class="section-title">
                            <i class="fas fa-university"></i> Të Dhënat Bankare
                        </div>
                        <div class="form-columns">
                            <div class="form-group">
                                <label>Banka <span class="required">*</span></label>
                                <div class="input-wrapper">
                                    <i class="fas fa-landmark input-icon"></i>
                                    <input type="text" name="banka" placeholder="p.sh. ProCredit Bank" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" name="iban" placeholder="XK05121201234567890..." required>
                                </div>
                                <small class="field-info">Duhet të fillojë me XK</small>
                            </div>
                        </div>
                        <div class="form-columns full">
                            <div class="form-group">
                                <label>Numri i Llogarisë <span class="required">*</span></label>
                                <div class="input-wrapper">
                                    <i class="fas fa-credit-card input-icon"></i>
                                    <input type="text" name="llogaria" placeholder="Vetëm shifra" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-group">
                        <div class="section-title">
                            <i class="fas fa-credit-card"></i> Mënyra e Pagesës
                        </div>
                    ...
                    <div class="button-group">
                        <button type="submit">
                            <i class="fas fa-check"></i> Regjistro Zyrën
                        </button>
                    </div>

                    <div class="backup-indicator">
                        <i class="fas fa-shield-alt"></i>
                        Të dhënat tuaja ruhen automatikisht në sistem të sigurt
                    </div>
                </form>
            </div>
        </div>
