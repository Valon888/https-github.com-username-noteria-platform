...
function Header()
{
    // Override this method in your subclass to add a custom header to each page
}

function Footer()
{
    // Override this method in your subclass to add a custom footer to each page
}
...
try {
    ...
    $pdf->Cell(100, 8, utf8_to_win1252('Klienti: Agim Hoxha'), 0, 0);
    $pdf->Cell(0, 8, utf8_to_win1252('Data: ') . date('d.m.Y'), 0, 1);
    $pdf->Cell(100, 8, utf8_to_win1252('Adresa: Rr. Shembull, Prishtinë'), 0, 1);
    $pdf->Cell(100, 8, utf8_to_win1252('Nr. Faturës: 2025-001'), 0, 1);
    $pdf->Ln(8);
    ...
    $pdf->SetFont('Arial', '', 12);
    $pdf->Cell(80, 8, utf8_to_win1252('Shërbim Noterial'), 1);
    $pdf->Cell(30, 8, '1', 1, 0, 'C');
    $pdf->Cell(40, 8, '50.00 EUR', 1, 0, 'C');
    $pdf->Cell(40, 8, '50.00 EUR', 1, 1, 'C');
